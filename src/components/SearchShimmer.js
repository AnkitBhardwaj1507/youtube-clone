...
const SearchShimmer = () => {
    return (
        <div className="grid md:grid-cols-12 bg-gray-50 dark:bg-slate-800 max-sm:px-10 max-sm:pb-10">
            {/* thumbnails */}
            <div className="md:col-span-3 col-span-12 bg-gray-300 mr-2 rounded-lg dark:bg-sllate-600 h-40"></div>
