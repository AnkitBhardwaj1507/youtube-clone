...
//Each Video Card in Search result Page
const SearchVideoCard = ({ data }) => {
    ...
    // Getting Channel Deatils with channel id
    ...
    return (
        <div className='flex max-sm:flex-col flex-row bg-gray-50 py-2 dark:bg-slate-800 maz-sm:px-10 max-sm:pb-10'>
            {/* thumbnails */}
